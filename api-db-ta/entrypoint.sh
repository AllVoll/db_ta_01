...
sed -i "s/sqlalchemy.url = .*/sqlalchemy.url = postgresql:\/\/av:av@timescale:5432\/av/" /usr/src/app/alembic.ini
...
engine = create_engine('postgresql://av:av@timescale:5432/av')
